export const addProblem = async (data) => {
    ...
    const response = await fetch("/api/addproblemlist", requestOptions)
    const {
        success
    } = await response.json()
...
export const getAllProblemsForDoctor = async (patientId) => {
    ...
    const response = await fetch("/api/getproblemlistbydoctor/"+patientId, requestOptions)
    const {
        history
    } = await response.json()
...
export const getAllProblemsForPatient = async () => {
    ...
    const response = await fetch("/api/getproblemlistbypatient", requestOptions)
    const {
        history
    } = await response.json()
