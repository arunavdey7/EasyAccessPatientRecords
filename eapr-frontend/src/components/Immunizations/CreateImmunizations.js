...
const CreateImmunizations = () => {
    ...
    const [data, setData] = useState({
        ...
        absence_of_info_absence_statement:'No Info',
    ...
    return(
        ...
        <div className='form_container'>
            ...
            <input name='immunization_item' value={data.immunization_item || ''} onChange={handleChange}></input>
            <br/>
            <h2>Administration details</h2>
            <label>Route</label>
            <input name='administration_details_route' value={data.administration_details_route || ''} onChange={handleChange}></input>
            <br/>
            ...
            <input  type='date' name='absence_of_info_protocol_last_updated' value={data.absence_of_info_protocol_last_updated || ''} onChange={handleChange}></input>
            <br/>
