            ...
            setVitals(
                {
                    ...
                    bloodPressure : vitalsRes.blood_pressure_systolic+' / '+vitalsRes.blood_pressure_dystolic,
                            ...
                            <div className='vital_signs_thumbnail_container'>
                                ...
                                <div style={{display:"flex"}}>
                                    ...
                                    <div className='vital_sign_tumbnail_label'>
                                        <h2>Body Temperature:
                                            <span className='vital_values'>{vitals.bodyTemperature} C</span>
                                        </h2>
                                    </div>
                                </div>
                                ...
                                <div style={{display:"flex"}}>
                                    ...
                                    <div className='vital_sign_tumbnail_label'>
                                        <h2>Blood Pressure:
                                            <span className='vital_values'>{vitals.bloodPressure} mmHg</span>
                                        </h2>
                                    </div>
                                </div>
                                ...
                                <div style={{display:"flex"}}>
                                    ...
                                    <div className='vital_sign_tumbnail_label'>
                                        <h2>Respiration Rate:
                                            <span className='vital_values'>{vitals.respirationRate} cpm</span>
                                        </h2>
                                    </div>
                                </div>
                                ...
                                <div style={{display:"flex"}}>
                                    ...
                                    <div className='vital_sign_tumbnail_label'>
                                        <h2>Pulse rate:
                                            <span className='vital_values'>{vitals.bodyTemperature} bpm</span>
                                        </h2>
                                    </div>
                                </div>
                                ...
                                <div style={{display:"flex"}}>
                                    ...
                                    <div className='vital_sign_tumbnail_label'>
                                        <h2>Body Weight:
                                            <span className='vital_values'>{vitals.bodyWeight} kgs</span>
                                        </h2>
                                    </div>
                                </div>
                                ...
                                <div style={{display:"flex"}}>
                                    ...
                                    <div className='vital_sign_tumbnail_label'>
                                        <h2>Body Mass Index:
                                            <span className='vital_values'>{vitals.bodyMassIndex} kg/m2</span>
                                        </h2>
                                    </div>
                                </div>
